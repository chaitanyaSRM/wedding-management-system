            ...
            if (isset($_SESSION['uname'])) {
              $name=$_SESSION['urname'];
               ...
               $row=mysqli_fetch_array($run);
                ...
                $date=$row['wdate'];
                $pno=$row['pno'];
                $s = 100; // Fixed base cost instead of multiplying by phone number
                $vid=$row['vid'];
                $tid=$row['tid'];
                $did=$row['did'];
                $pid=$row['pid'];
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                  At UV Wedding Management, we are a dynamic and experienced team dedicated to making your special day truly unforgettable. Our expertise spans over 3 years, with a proven track record of delivering exceptional services to 36 satisfied clients.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                  <path d="M13.468 12.37C12.758 11.226 11.383 10.5 8 10.5s-4.758.726-5.468 1.87A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box text-center">
            <p class="copyright" style="color: #ffc107; font-size: 14px; margin-bottom: 5px;">
