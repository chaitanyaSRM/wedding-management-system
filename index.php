...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">UV Wedding Management</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">UV Wedding Management</h1>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    Welcome to UV Wedding Management, where we specialize in creating unforgettable wedding experiences. With over 3 years of expertise in the wedding planning industry, we have successfully organized more than 450 weddings, ensuring every detail is perfect.
                  <!-- </p>
                  <p class="lead">
                    Our team, led by Umesh and Vansh, is dedicated to providing exceptional services, including venue selection, catering, decoration, music, photography, and theme customization. We pride ourselves on delivering personalized solutions tailored to your unique preferences and vision.
                  </p>
                  <p class="lead">
                    At UV Wedding Management, we believe that every wedding is a story waiting to be told. Let us help you write yours with elegance, style, and perfection.
                  </p> -->
                </div>
              </div>
            </div>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <svg xmlns="http://www.w3.org/2000/svg" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                  <path d="M13.468 12.37C12.758 11.226 11.383 10.5s-4.758.726-5.468 1.87A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
                  <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1z"/>
                </svg>
                <span class="author">Umesh</span>
              </div>
            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <p class="lead">Tambaram, Chennai</p>
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span> Tambaram, Chennai</li>
                      <li><span class="ion-ios-telephone"></span> 7842034732</li>
                      <li><span class="ion-ios-telephone"></span> +91 6350 370 167</li>
                      <li><span class="ion-email"></span> uvwedd@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box text-center">
              <p class="copyright" style="color: #ffffff; font-size: 14px; margin-bottom: 5px;">
                &copy; Copyright <strong>UV Wedding Management</strong>. All Rights Reserved
              </p>
              <div class="credits" style="color: #f8f9fa; font-size: 13px;">
                Designed by <a href="#" style="color: #ffc107; text-decoration: none;">Umesh and Vansh</a>
              </div>
            </div>
          </div>
        </div>
