     ...
     case 'cid':
         ...
         if (mysqli_num_rows($run) == 0) {
             ...
             if ($row) { // Check if $row is not null
                 ...
                 echo "<h2 class='text-center'>Details not found in catering table</h2>";
             }
         }
         break;
     ...
     case 'pid':
         ...
         if (mysqli_num_rows($run) == 0) {
             ...
             if ($row) { // Check if $row is not null
                 ...
                 echo "<h2 class='text-center'>Details not found in photoshop table</h2>";
             }
         }
         break;
     ...
     case 'tid':
         ...
         if (mysqli_num_rows($run) == 0) {
             ...
             if ($row) { // Check if $row is not null
                 ...
                 echo "<h2 class='text-center'>Details not found in theme table</h2>";
             }
         }
         break;
     ...
     case 'mid':
         ...
         if (mysqli_num_rows($run) == 0) {
             ...
             if ($row) { // Check if $row is not null
                 ...
                 echo "<h2 class='text-center'>Details not found in music table</h2>";
             }
         }
         break;
     ...
     case 'vid':
         ...
         if (mysqli_num_rows($run) == 0) {
             ...
             if ($row) { // Check if $row is not null
                 ...
                 echo "<h2 class='text-center'>Details not found in venue table</h2>";
             }
         }
         break;
     ...
     case 'did':
         ...
         if (mysqli_num_rows($run) == 0) {
             ...
             if ($row) { // Check if $row is not null
                 ...
                 echo "<h2 class='text-center'>Details not found in decoration table</h2>";
             }
         }
         break;
   }
